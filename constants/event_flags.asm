...
; Johto story events
	...
	const EVENT_GOT_TM12_QUICK_ATTACK_FROM_MOOMOO_FARM
	...
	const EVENT_GOT_TM09_PSYCH_UP
	const EVENT_RELEASED_THE_BEASTS
	const EVENT_GOT_MASTER_BALL_FROM_ELM
; Johto Signpost Items
	const EVENT_TIN_TOWER_4F_HIDDEN_FOSSIL
	const EVENT_TIN_TOWER_5F_HIDDEN_FOSSIL
	const EVENT_TIN_TOWER_5F_HIDDEN_FOSSIL1
	const EVENT_BURNED_TOWER_1F_HIDDEN_FOSSIL ; 080
	const EVENT_081
	const EVENT_082
	const EVENT_083
	const EVENT_NATIONAL_PARK_HIDDEN_FOSSIL
	const EVENT_OLIVINE_LIGHTHOUSE_5F_HIDDEN_FOSSIL
	const EVENT_TEAM_ROCKET_BASE_B1F_HIDDEN_FOSSIL
	const EVENT_TEAM_ROCKET_BASE_B2F_HIDDEN_FOSSIL
	const EVENT_ILEX_FOREST_HIDDEN_FOSSIL
	const EVENT_ILEX_FOREST_HIDDEN_FOSSIL1
	const EVENT_ILEX_FOREST_HIDDEN_FOSSIL2
	const EVENT_WAREHOUSE_ENTRANCE_HIDDEN_FOSSIL
	const EVENT_WAREHOUSE_ENTRANCE_HIDDEN_FOSSIL1
	const EVENT_WAREHOUSE_ENTRANCE_HIDDEN_FOSSIL2
	const EVENT_UNDERGROUND_PATH_SWITCH_ROOM_ENTRANCES_HIDDEN_FOSSIL
	const EVENT_UNDERGROUND_PATH_SWITCH_ROOM_ENTRANCES_HIDDEN_FOSSIL1
	const EVENT_MOUNT_MORTAR_1F_OUTSIDE_HIDDEN_FOSSIL
	const EVENT_MOUNT_MORTAR_1F_INSIDE_HIDDEN_FOSSIL
	const EVENT_MOUNT_MORTAR_2F_INSIDE_HIDDEN_FOSSIL
	const EVENT_MOUNT_MORTAR_B1F_HIDDEN_FOSSIL
	const EVENT_ICE_PATH_B1F_HIDDEN_FOSSIL
	const EVENT_ICE_PATH_B2F_MAHOGANY_SIDE_HIDDEN_FOSSIL
	const EVENT_ICE_PATH_B2F_BLACKTHORN_SIDE_HIDDEN_FOSSIL
	const EVENT_WHIRL_ISLAND_B1F_HIDDEN_FOSSIL
	const EVENT_WHIRL_ISLAND_B1F_HIDDEN_FOSSIL1
	const EVENT_WHIRL_ISLAND_B1F_HIDDEN_FOSSIL2
	const EVENT_SILVER_CAVE_ROOM_1_HIDDEN_FOSSIL
	const EVENT_SILVER_CAVE_ROOM_1_HIDDEN_FOSSIL1
	const EVENT_SILVER_CAVE_ROOM_2_HIDDEN_FOSSIL
	const EVENT_DARK_CAVE_VIOLET_ENTRANCE_HIDDEN_FOSSIL
	const EVENT_VICTORY_ROAD_HIDDEN_FOSSIL
	const EVENT_VICTORY_ROAD_HIDDEN_FOSSIL1
	const EVENT_DRAGONS_DEN_B1F_HIDDEN_FOSSIL
	const EVENT_DRAGONS_DEN_B1F_HIDDEN_FOSSIL1
	const EVENT_DRAGONS_DEN_B1F_HIDDEN_FOSSIL2
	const EVENT_ROUTE_28_HIDDEN_FOSSIL
	const EVENT_ROUTE_30_HIDDEN_FOSSIL
	const EVENT_ROUTE_32_HIDDEN_FOSSIL
	const EVENT_ROUTE_32_HIDDEN_FOSSIL1
	const EVENT_ROUTE_34_HIDDEN_FOSSIL
	const EVENT_ROUTE_34_HIDDEN_FOSSIL1
	const EVENT_ROUTE_37_HIDDEN_FOSSIL
	const EVENT_ROUTE_39_HIDDEN_FOSSIL
	const EVENT_ROUTE_40_HIDDEN_FOSSIL
	const EVENT_ROUTE_41_HIDDEN_FOSSIL
	const EVENT_ROUTE_42_HIDDEN_FOSSIL
	const EVENT_ROUTE_44_HIDDEN_FOSSIL
	const EVENT_ROUTE_45_HIDDEN_FOSSIL
	const EVENT_VIOLET_CITY_HIDDEN_FOSSIL
	const EVENT_AZALEA_TOWN_HIDDEN_FOSSIL
	const EVENT_CIANWOOD_CITY_HIDDEN_FOSSIL
	const EVENT_CIANWOOD_CITY_HIDDEN_FOSSIL1
	const EVENT_ECRUTEAK_CITY_HIDDEN_FOSSIL
	const EVENT_LAKE_OF_RAGE_HIDDEN_FOSSIL
	const EVENT_LAKE_OF_RAGE_HIDDEN_FOSSIL1
	const EVENT_LAKE_OF_RAGE_HIDDEN_FOSSIL2
	const EVENT_SILVER_CAVE_OUTSIDE_HIDDEN_FOSSIL
...
; Kanto Signpost Items
	const EVENT_DIGLETTS_CAVE_HIDDEN_FOSSIL
	const EVENT_UNDERGROUND_HIDDEN_FOSSIL
	const EVENT_UNDERGROUND_HIDDEN_FOSSIL1
	const EVENT_ROCK_TUNNEL_1F_HIDDEN_FOSSIL
	const EVENT_ROCK_TUNNEL_1F_HIDDEN_FOSSIL1
	const EVENT_ROCK_TUNNEL_B1F_HIDDEN_FOSSIL
	const EVENT_OLIVINE_PORT_HIDDEN_FOSSIL
	const EVENT_VERMILION_PORT_HIDDEN_FOSSIL
	const EVENT_MOUNT_MOON_SQUARE_HIDDEN_MOON_STONE
	const EVENT_ROUTE_2_HIDDEN_FOSSIL
	const EVENT_ROUTE_2_HIDDEN_FOSSIL1
	const EVENT_ROUTE_2_HIDDEN_FOSSIL2
	const EVENT_ROUTE_2_HIDDEN_FOSSIL3
	const EVENT_ROUTE_4_HIDDEN_FOSSIL
	const EVENT_ROUTE_9_HIDDEN_FOSSIL
	const EVENT_ROUTE_12_HIDDEN_FOSSIL
	const EVENT_ROUTE_13_HIDDEN_FOSSIL
	const EVENT_ROUTE_11_HIDDEN_FOSSIL
	const EVENT_ROUTE_17_HIDDEN_FOSSIL
	const EVENT_ROUTE_17_HIDDEN_FOSSIL1
	const EVENT_ROUTE_25_HIDDEN_FOSSIL
	...
	const EVENT_VERMILION_CITY_HIDDEN_FOSSIL
	const EVENT_CELADON_CITY_HIDDEN_FOSSIL
	const EVENT_CINNABAR_ISLAND_HIDDEN_FOSSIL
	const EVENT_BURNED_TOWER_1F_HIDDEN_FOSSIL1
...
; White Crystal New Events
	...
	const EVENT_5_CAUGHT_REWARD
	const EVENT_10_CAUGHT_REWARD
	const EVENT_20_CAUGHT_REWARD
	const EVENT_35_CAUGHT_REWARD
	const EVENT_50_CAUGHT_REWARD
	const EVENT_75_CAUGHT_REWARD
	const EVENT_100_CAUGHT_REWARD
	const EVENT_150_CAUGHT_REWARD
	const EVENT_200_CAUGHT_REWARD
	const EVENT_251_CAUGHT_REWARD
	const EVENT_CAUGHT_REWARD_EXPLAINED
	const EVENT_FOUGHT_MEWTWO
	const EVENT_GAVE_KURTDAUGHTER_RED_APRICORN
	const EVENT_GAVE_KURTDAUGHTER_BLU_APRICORN
	const EVENT_GAVE_KURTDAUGHTER_YLW_APRICORN
	const EVENT_GAVE_KURTDAUGHTER_GRN_APRICORN
...
; Johto items: 0x640
	...
	const EVENT_BURNED_TOWER_B1F_TM_ANCIENTPOWER
	...
	const EVENT_UNDERGROUND_WAREHOUSE_TM_ZEN_HEADBUTT
	...
	const EVENT_MOUNT_MORTAR_2F_INSIDE_TM_BELLY_DRUM
	...
	const EVENT_DARK_CAVE_BLACKTHORN_ENTRANCE_TM_ENERGY_BALL
