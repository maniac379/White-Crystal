...
BattleTowerMons1:
	...
	db TAUROS
	db KINGS_ROCK
	db HEADBUTT, SWAGGER, TAIL_WHIP, MAGNITUDE
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons3:
	...
	db LAPRAS
	db LEFTOVERS
	db RAIN_DANCE, WATER_GUN, POWDER_SNOW, STRENGTH
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db PRIMEAPE
	db MIRACLEBERRY
	db LOW_KICK, KARATE_CHOP, REVERSAL, MACH_PUNCH
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons4:
	...
	db ELECTABUZZ
	db KINGS_ROCK
	db LIGHT_SCREEN, THUNDERPUNCH, SWIFT, CROSS_CHOP
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons5:
	...
	db ARTICUNO
	db GOLD_BERRY
	db BLIZZARD, HYPER_BEAM, ROAR, HAIL
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 40000
...
BattleTowerMons6:
	...
	db DRAGONITE
	db MIRACLEBERRY
	db HYPER_BEAM, ICE_BEAM, THUNDERBOLT, SURF
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db JYNX
	db MIRACLEBERRY
	db BLIZZARD, PSYCHIC_M, SHADOW_BALL, ICE_BEAM
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db SANDSLASH
	db SCOPE_LENS
	db EARTHQUAKE, SLASH, HYPER_BEAM, AERIAL_ACE
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons9:
	...
	db CLOYSTER
	db LEFTOVERS
	db EXPLOSION, BLIZZARD, SURF, ICE_BEAM
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 50000
