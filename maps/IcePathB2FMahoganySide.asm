...
IcePathB2FMahoganySideHiddenFossil:
	dwb EVENT_ICE_PATH_B2F_MAHOGANY_SIDE_HIDDEN_FOSSIL, FOSSIL
...
.Signposts:
	db 1
	signpost 17, 0, SIGNPOST_ITEM, IcePathB2FMahoganySideHiddenFossil
