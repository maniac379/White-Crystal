...
IcePathB2FBlackthornSideHiddenFossil:
	dwb EVENT_ICE_PATH_B2F_BLACKTHORN_SIDE_HIDDEN_FOSSIL, FOSSIL
...
.Signposts:
	db 1
	signpost 10, 2, SIGNPOST_ITEM, IcePathB2FBlackthornSideHiddenFossil
