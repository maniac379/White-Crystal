...
DarkCaveBlackthornEntranceTMEnergyBall:
...
.PersonEvents:
	...
	person_event SPRITE_POKE_BALL, 22, 7, SPRITEMOVEDATA_ITEM_TREE, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, DarkCaveBlackthornEntranceTMEnergyBall, EVENT_DARK_CAVE_BLACKTHORN_ENTRANCE_TM_ENERGY_BALL
