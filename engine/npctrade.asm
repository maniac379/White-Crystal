...
ENDM
	...
	npctrade 0, EEVEE, PONYTA,       "FLARE@@@@@@", $96, $66, EVERSTONE, 48926, "KYLE@@@@@@@", TRADE_EITHER_GENDER
	npctrade 0, WOOPER,       HORSEA,     "HORSEY@@@@@", $37, $66, DRAGON_SCALE,   37460, "MIKE@@@@@@@", TRADE_EITHER_GENDER
	npctrade 1, FARFETCH_D,     SNORLAX,    "SLOTH@@@@@@", $98, $88, LEFTOVERS, 29189, "TIM@@@@@@@@", TRADE_EITHER_GENDER
	npctrade 3, PINSIR,  DRATINI,     "DORIS@@@@@@", $77, $66, BRIGHTPOWDER,   00283, "EMY@@@@@@@@", TRADE_FEMALE_ONLY
	npctrade 2, CHARMANDER,    CYNDAQUIL,       "SPIKE@@@@@@", $96, $86, RARE_CANDY, 15616, "CHRIS@@@@@@", TRADE_EITHER_GENDER
	npctrade 3, SQUIRTLE,    TOTODILE, "CHOMP@@@@@", $96, $66, RARE_CANDY,   26491, "KIM@@@@@@@@", TRADE_EITHER_GENDER
	npctrade 0, BULBASAUR,    CHIKORITA,   "TEAL@@@@@@@", $96, $66, RARE_CANDY,   50082, "FOREST@@@@@", TRADE_EITHER_GENDER
; fcf38
