...
ENDM
	...
	move POUND,        EFFECT_NORMAL_HIT,         40, NORMAL,   100, 35,   0, PHYSICAL
 	...
 	move GUILLOTINE,   EFFECT_OHKO,                1, NORMAL,    30,  5,   0, PHYSICAL
 	move NASTY_PLOT,   EFFECT_SP_ATK_UP_2,         0, DARK,     100, 10,   0, STATUS
 	...
 	move BIND,         EFFECT_BIND,               15, NORMAL,    85, 20,   0, PHYSICAL
 	...
 	move WRAP,         EFFECT_BIND,               15, NORMAL,    90, 20,   0, PHYSICAL
 	...
 	move SONICBOOM,    EFFECT_STATIC_DAMAGE,      20, NORMAL,    100, 20,   0, SPECIAL
 	...
 	move SUBMISSION,   EFFECT_RECOIL_HIT,         80, FIGHTING,  100, 20,   0, PHYSICAL
 	...
 	move RAZOR_LEAF,   EFFECT_NORMAL_HIT,         55, GRASS,    100, 25,   0, PHYSICAL
 	...
 	move STRING_SHOT,  EFFECT_SPEED_DOWN,          0, BUG,      100, 40,   0, STATUS
 	move DRAGON_RAGE,  EFFECT_STATIC_DAMAGE,      40, DRAGON,   100, 10,   0, SPECIAL
 	move FIRE_SPIN,    EFFECT_BIND,               35, FIRE,      85, 15,   0, SPECIAL
	...
	move AIR_SLASH,    EFFECT_FLINCH_HIT,         75, FLYING,   100, 15,  30, SPECIAL
 	...
 	move PSYWAVE,      EFFECT_PSYWAVE,             1, PSYCHIC,   100, 15,   0, SPECIAL
 	move SPLASH,       EFFECT_SPLASH,              0, NORMAL,   100, 40,   0, STATUS
 	move ACID_ARMOR,   EFFECT_DEFENSE_UP_2,        0, POISON,   100, 20,   0, STATUS
 	...
 	move ROCK_POLISH,  EFFECT_SPEED_UP_2,          0, ROCK,     100, 20,   0, STATUS
 	...
 	move AEROBLAST,    EFFECT_NORMAL_HIT,        100, FLYING,   100,  5,   0, SPECIAL
 	...
 	move FURY_CUTTER,  EFFECT_FURY_CUTTER,        40, BUG,      100, 20,   0, PHYSICAL
 	move STEEL_WING,   EFFECT_STEEL_WING,         70, STEEL,     90, 25,  10, PHYSICAL
 	...
 	move SACRED_FIRE,  EFFECT_SACRED_FIRE,       100, FIRE,     100,  5,  50, PHYSICAL
 	...
 	move METAL_CLAW,   EFFECT_METAL_CLAW,         50, STEEL,    100, 35,  10, PHYSICAL
 	...
 	move ANCIENTPOWER, EFFECT_ANCIENTPOWER,       60, ROCK,     100,  10,  10, SPECIAL
 	move SHADOW_BALL,  EFFECT_SP_DEF_DOWN_HIT,    80, GHOST,    100, 15,  20, SPECIAL
 	move FUTURE_SIGHT, EFFECT_FUTURE_SIGHT,      120, PSYCHIC,   90, 10,   0, SPECIAL
 	move ROCK_SMASH,   EFFECT_DEFENSE_DOWN_HIT,   40, FIGHTING, 100, 15,  50, PHYSICAL
 	move WHIRLPOOL,    EFFECT_BIND,               35, WATER,     85, 15,   0, SPECIAL
