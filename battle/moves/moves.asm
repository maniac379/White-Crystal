...
ENDM
	...
	move POUND,        EFFECT_NORMAL_HIT,         40, NORMAL,   100, 35,   0, PHYSICAL
 	...
 	move FLY,          EFFECT_FLY,                70, FLYING,    100, 15,   0, PHYSICAL
 	move BIND,         EFFECT_BIND,               15, NORMAL,    75, 20,   0, PHYSICAL
 	...
 	move SUBMISSION,   EFFECT_RECOIL_HIT,         80, FIGHTING,  100, 25,   0, PHYSICAL
 	...
 	move FIRE_SPIN,    EFFECT_BIND,               15, FIRE,      70, 15,   0, SPECIAL
 	...
 	move CLAMP,        EFFECT_BIND,               35, WATER,     75, 10,   0, PHYSICAL
	...
	move AIR_SLASH,    EFFECT_FLINCH_HIT,         75, FLYING,    95, 15,  30, SPECIAL
 	...
 	move GIGA_DRAIN,   EFFECT_LEECH_HIT,          70, GRASS,    100,  10,   0, SPECIAL
 	...
 	move METAL_CLAW,   EFFECT_METAL_CLAW,         50, STEEL,     95, 35,  10, PHYSICAL
 	...
 	move WHIRLPOOL,    EFFECT_BIND,               15, WATER,     70, 15,   0, SPECIAL
